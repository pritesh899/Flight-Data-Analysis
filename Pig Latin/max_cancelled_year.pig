...
filter_cancelled = filter c_cancel by CANCELLED == 1;
g_filter_cancelled = group filter_cancelled by YEAR;
cnt_cancelled = foreach g_filter_cancelled generate group, COUNT(filter_cancelled.CANCELLED);
max_cancelled = limit cnt_cancelled 30;
store max_cancelled into 's3://flightdataanalysis/max_cancelled_year';