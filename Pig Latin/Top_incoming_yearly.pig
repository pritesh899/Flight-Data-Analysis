...
incoming = foreach A generate MONTH as m, DEST as d, YEAR as y;
g_incoming = group incoming by (y,m,d);
...
store result into 's3://flightdataanalysis/topone_incoming_traffic_yearly';