...
incoming = foreach A generate MONTH as m, ORIGIN as o;
g_incoming = group incoming by (m,o);
...
store result into 's3://flightdataanalysis/topone_outgoing_traffic_monthly';